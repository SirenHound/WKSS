...
try{
    ...
    o.Class.extend = function (props) {
        ...
        var proto = o.Util.create(parentProto);
        ...
        if (props.statics) {
            o.extend(NewClass, props.statics);
            delete props.statics;
        }

        // mix includes into the prototype
        if (props.includes) {
            o.extend.apply(null, [proto].concat(props.includes));
            delete props.includes;
        }

        // merge options
        if (proto.options) {
            props.options = o.extend(o.Util.create(proto.options), props.options);
        }

        // mix given properties into the prototype
        o.extend(proto, props);
    ...
    o.Class.include = function (props) {
        o.extend(this.prototype, props);
    };
    // merge new default options to the Class
    o.Class.mergeOptions = function (options) {
        o.extend(this.prototype.options, options);
    };
    // add a constructor hook
    o.Class.addInitHook = function (fn) { // (Function) || (String, args...)
    ...
    */
    ...
    o.Button = o.Node.extend({
        options:{
            type: "button"
        },
        initialize:function(options){
            info("opt:", this.options);
            o.Node.prototype.initialize.call(this, "input", options);
